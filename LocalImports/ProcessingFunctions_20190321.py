...
def generate_filenames_dict(input_folder, data_type1, data_type2,
    ...
    input_dict['output_detrend_smooth_Pre'] = output_folder+data_type1+'Pre_'+data_type2+'_signal_detrend_denoise'+output_extension
    input_dict['output_detrend_smooth_Post'] = output_folder+data_type1+'Post_'+data_type2+'_signal_detrend_denoise'+output_extension
    ...
    input_dict['output_cosine_params_Pre'] = output_folder+data_type1+'Pre_'+data_type2+'_oscillatory_params'+output_extension
    input_dict['output_cosine_params_Post'] = output_folder+data_type1+'Post_'+data_type2+'_oscillatory_params'+output_extension
...
def load_imagej_file(input_data, raw_signal, raw_xy, color, input_ij_extension=None):
    ...
    if input_ij_extension=='.csv':
        ...
        ij_sheet = ij_file[list(ij_file.keys())[0]]
    ...
    # delete the rest
    orig_keys = np.copy(list(ij_sheet.keys()))
